//lp103 - webflow with city as others
...
async function submitForm() {
    try {
        ...
        await chooseCityDropdown.sendKeys('Others', Key.RETURN);

         // Check if custom city field is visible
         const customCityField = await driver.findElement(By.name('City-Name'));
        
         // If the custom city field is visible, enter a custom city name
         if (await customCityField.isDisplayed()) {
